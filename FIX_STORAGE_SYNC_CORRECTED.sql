-- FIX_STORAGE_SYNC_CORRECTED.sql
-- This script will fix the storage synchronization issue using the correct table structure
...
-- Using only the columns that actually exist in your table
